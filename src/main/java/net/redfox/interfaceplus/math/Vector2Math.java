...
public class Vector2Math {
	/**
	 * Calculates the geometrical distance between two points using the Pythagorean
	 * theorem.
	 *
	 * @param origin
	 *            The starting point
	 * @param goal
	 *            The ending point
	 * @return A double containing the distance from the starting point to the
	 *         ending point.
	 */
	...
	/**
	 * Calculates the direction that one would need to travel to get from origin to
	 * goal.
	 *
	 * @param origin
	...
	/**
	 * Calculates x and y increments that need to be added to your current x and y
	 * position to move speed units in radians direction
	 *
	 * @param radians
	 *            The angle in radians that you are traveling
	 * @param speed
	 *            The speed at which you are going
	 * @return A Vector2 containing the increments that should be added to your
	 *         position to move speed units in radians direction
	 */
	...
	/**
	 * Calculates the increments required to be added to a position in order to move
	 * speed units towards goal from origin
	 *
	 * @param origin
	...
	public static Vector2 getIncrementsFromPoint(Vector2 origin, Vector2 goal, double speed) {
		...
		if (distance > speed)
			return getIncrementsBySpeed(getDirectionToPoint(origin, goal), speed);
