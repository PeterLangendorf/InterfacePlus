...
public class KeyHandler implements KeyListener {
	...
	/**
	 * Adds a task to run when the specified key is typed. This will fire once every
	 * time the user presses down on the key.
	 * 
	 * @param task
	 *            The task to run.
	 * @param keyCode
	 *            The key that must be typed to run the task, as specified by the
	 *            static keycodes in {@link KeyEvent}.
	 */
	public static void addTypedKeyEvent(Task task, int keyCode) {
		updateList(TYPE_EVENTS, task, keyCode);
	}
	/**
	 * Adds a task to run when the specified key is pressed. This will fire once per
	 * frame while the key is held down.
	 * 
	 * @param task
	 *            The task to run.
	 * @param keyCode
	 *            The key that must be pressed to run the task, as specified by the
	 *            static keycodes in {@link KeyEvent}.
	 */
	...
	/**
	 * Adds a task to run when the specified key is released. This will fire once
	 * when the key is released.
	 * 
	 * @param task
	 *            The task to run.
	 * @param keyCode
	 *            The key that must be released to run the task, as specified by the
	 *            static keycodes in {@link KeyEvent}.
	 */
